This code is heavily reliant on the code found in the following github: https://github.com/centreborelli/HDR-DSP-SR. For licensing information please see their Github. This temporary repo will update the requirements with a requirements.txt file, add additional data, and make the code more modular in the data input structure.
